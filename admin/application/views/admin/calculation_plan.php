                ...
                <div class="box-content">
                    ...
                    <form id="form2" name="form2">
                        <div id="form20" name="form20">
                            ...
                            <form action="<?php echo base_url()?>cimport/uploadData" method='POST' enctype="multipart/form-data">
                    ...
                    function loadgrid() {
                        ...
                        $("#grid").kendoGrid({
                            ...
                            columns: [
                                ...
                                { title:"Percentage",width:75,headerAttributes: {style: "font-weight: bold"} ,editable: "false",
                                template: "<div class='progress' style='background-color: rgba(188, 196, 191, 0.3);'> <div class='progress-bar progress-bar-striped' role='progressbar' style='width:50%; background-color: coral;' aria-valuenow='50' aria-valuemin='0' aria-valuemax='100' id='progressBar'>50%</div></div>"
                                },
                            ]
