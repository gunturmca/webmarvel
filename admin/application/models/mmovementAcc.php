	...
	public function hdr($field,$fromdate,$todate,$qhour)
	 {
		...
		$sql = "WITH
		group1 as (
					SELECT   row_number() over (partition by b.qProdCode order by a.movetime)  AS RowNo,b.qProdCode,a.Loc_From,a.Loc_Dest,a.LocImport
		
						from trnMovement as a inner join mAccessories as b on a.QRNumber = b.QRNumber where (b.qProdCode is not null or b.qProdCode <> '') and  (b.qPO is not null or b.qPO <> '') 
						and (a.movedate between '$fromdate' and '$todate')  and  format(a.movetime,'HH') = '$qhour'  
						group by a.Loc_From,a.Loc_Dest,b.qProdCode,a.movetime,a.LocImport
				),
		 movement AS 
				(
					SELECT  top 10000 ROW_NUMBER() OVER(partition by b.qProdCode,a.movetime,a.LocImport ORDER BY b.qProdCode,a.movetime,a.LocImport ) AS RowNo, a.OnSite,a.QRNumber,a.MoveDate,a.movetime,format(a.movetime,'HH') as qHour, b.qProdCode,b.qProdDesc,b.qPO,a.LocImport,a.QtyYard,a.QtyKgs,a.Qty,a.Loc_From,a.Loc_Dest
					,a.SageStatus,a.SageUpdateBy, a.SageUpdateTime,a.SageMoveId, a.LocImport
						from trnMovement as a inner join mAccessories as b on a.QRNumber = b.QRNumber where (b.qProdCode is not null or b.qProdCode <> '') and  (b.qPO is not null or b.qPO <> '')
						and (a.movedate between '$fromdate' and '$todate')  and  format(a.movetime,'HH') = '$qhour'  
				),
		movement2 as (
						select distinct row_number() over (partition by a.MoveDate,a.qHour,a.qProdCode,a.LocImport order by a.qProdCode,a.Loc_Dest,Loc_From,a.LocImport ) as rn,a.OnSite,a.MoveDate,qHour, a.qProdCode,a.LocImport,a.qProdDesc,a.qPO,a.Loc_From,a.Loc_Dest,b.LocationType,
						sum(a.QtyYard) as QtyYard,sum(a.QtyKgs) as QtyKgs ,sum(a.Qty) as Qty,iif (a.SageStatus <> 0,'checked','unchecked') as SageStatus , a.SageUpdateBy,a.SageUpdateTime,a.SageMoveId ,'' as chk,
						...
						group by a.OnSite,a.MoveDate,a.qHour,a.qProdCode,a.qProdDesc,a.LocImport,a.qPO,a.Loc_From,a.Loc_Dest,a.SageStatus,a.SageUpdateBy,a.SageUpdateTime, a.SageMoveId,b.LocationType
						),
		movement3 as (
				   SELECT distinct a.OnSite,a.MoveDate,a.qHour,a.qProdCode,a.qProdDesc,a.qPO,a.LocImport, a.QtyYard,a.QtyKgs,a.Qty , Loc_From,a.Loc_Dest, SageStatus ,a.SageUpdateBy,a.SageUpdateTime,a.SageMoveId,
		...
		movement4 as ( 
				   SELECT distinct row_number() over (partition by a.MoveDate,a.qHour,a.qProdCode order by a.qProdCode,a.Loc_Dest,Loc_From,a.LocImport ) as rn,a.OnSite,a.MoveDate,a.qHour,a.qProdCode,a.qProdDesc,a.qPO, a.QtyYard,a.QtyKgs, a.Qty , Loc_From,a.Loc_Dest, SageStatus ,a.SageUpdateBy,a.SageUpdateTime,a.SageMoveId,a.LocImport,
	...
	public function srchdr($fromdate,$todate,$statussage,$qhour, $ssource)
	 {
		...
		if ($ssource == 1 )
        {$locimp = "a.LocImport = 'LOCAL' ";}
		else if ($ssource == 2 )
        {$locimp = "a.LocImport = 'IMPORT' ";}
		else {$locimp = "a.LocImport in ('LOCAL', 'IMPORT')";}
			  $sql = "WITH
			  group1 as (
						  SELECT   row_number() over (partition by b.qProdCode order by a.movetime)  AS RowNo,b.qProdCode,a.Loc_From,a.Loc_Dest,a.LocImport
			  
							  from trnMovement as a inner join mAccessories as b on a.QRNumber = b.QRNumber where (b.qProdCode is not null or b.qProdCode <> '') and  (b.qPO is not null or b.qPO <> '') 
							  and (a.movedate between '$fromdate' and '$todate') and ".$locimp."
							  group by a.Loc_From,a.Loc_Dest,b.qProdCode,a.movetime,a.LocImport
					  ),
			   movement AS 
					  (
						  SELECT  top 10000 ROW_NUMBER() OVER(partition by b.qProdCode,a.movetime ORDER BY b.qProdCode,a.movetime ) AS RowNo, a.OnSite,a.QRNumber,a.MoveDate,a.movetime,format(a.movetime,'HH') as qHour, b.qProdCode,b.qProdDesc,b.qPO,a.QtyYard,a.QtyKgs,a.Qty,a.Loc_From,a.Loc_Dest,a.LocImport
						  ,a.SageStatus,a.SageUpdateBy, a.SageUpdateTime,a.SageMoveId
							  from trnMovement as a inner join mAccessories as b on a.QRNumber = b.QRNumber where (b.qProdCode is not null or b.qProdCode <> '') and  (b.qPO is not null or b.qPO <> '') 
							  and (a.movedate between '$fromdate' and '$todate') and ".$locimp."
					  ),
			  movement2 as (
							  select distinct row_number() over (partition by a.MoveDate,a.qHour,a.qProdCode order by a.qProdCode,a.Loc_Dest,Loc_From ) as rn,a.OnSite,a.MoveDate,qHour, a.qProdCode,a.qProdDesc,a.qPO,a.Loc_From,a.Loc_Dest,b.LocationType,a.LocImport,
							  sum(a.QtyYard) as QtyYard,sum(a.QtyKgs) as QtyKgs,sum(a.Qty) as Qty ,iif (a.SageStatus <> 0,'checked','unchecked') as SageStatus , a.SageUpdateBy,a.SageUpdateTime,a.SageMoveId ,'' as chk,
							  a.SageMoveId as SageMoveId1 from movement as a left join [192.168.2.8\SQLEXPRESS,41798].DBWarehouse.dbo.DimSTOCKLOC AS b on
							  a.Loc_from COLLATE DATABASE_DEFAULT = b.Location COLLATE DATABASE_DEFAULT
							  where " .$where. " and Loc_From <> a.Loc_Dest 
							  group by a.OnSite,a.MoveDate,a.qHour,a.qProdCode,a.LocImport,a.qProdDesc,a.qPO,a.Loc_From,a.Loc_Dest,a.SageStatus,a.SageUpdateBy,a.SageUpdateTime, a.SageMoveId,b.LocationType
							  ),
			  movement3 as (
						 SELECT distinct a.OnSite,a.MoveDate,a.qHour,a.qProdCode,a.qProdDesc,a.qPO,a.LocImport,a.QtyYard,a.QtyKgs,a.Qty , Loc_From,a.Loc_Dest, SageStatus ,a.SageUpdateBy,a.SageUpdateTime,a.SageMoveId,
						 a.chk,a.LocationType,d.StockUnit
						  ...
						  On a.qPO COLLATE DATABASE_DEFAULT = d.PONumber COLLATE DATABASE_DEFAULT and a.qProdCode COLLATE DATABASE_DEFAULT = d.Item COLLATE DATABASE_DEFAULT),
			  movement4 as ( 
						 SELECT distinct row_number() over (partition by a.MoveDate,a.qHour,a.qProdCode order by a.qProdCode,a.Loc_Dest,Loc_From ) as rn,a.OnSite,a.MoveDate,a.qHour,a.qProdCode,a.qProdDesc,a.qPO, a.QtyYard,a.QtyKgs,a.Qty , Loc_From,a.Loc_Dest, SageStatus ,a.SageUpdateBy,a.SageUpdateTime,a.SageMoveId,a.LocImport,
						 a.chk,a.LocationType,a.StockUnit from movement3 as a )
						 select * from movement4  where (Loc_From <> '' and Loc_From <> '-')  and (Loc_Dest <> '' and Loc_Dest <> '-') order by rn,qHour,qProdCode";
	...
	public function dtl($qProdCode,$qPO,$Loc_From,$fromdate,$Loc_Dest,$statussage,$qhour,$ssource)
	 {
		...
		from trnMovement as a left join mAccessories as b on a.QRNumber = b.QRNumber where b.qProdCode='$qProdCode' and b.qPO='$qPO'  and a.Loc_From = '$Loc_From' and a.Loc_Dest = '$Loc_Dest' and (a.movedate = '$fromdate') ". $statussage1 . " and format(a.movetime,'HH')  = '$qhour' and LocImport = '$ssource' ");
